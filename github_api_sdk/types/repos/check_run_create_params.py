...
class Variant0(TypedDict, total=False):
    ...
    If the integrator does not provide this, then the homepage of the GitHub app is
    used.
    """
...
class Variant0Output(TypedDict, total=False):
    ...
    This parameter supports Markdown. **Maximum length**: 65535 characters.
    """
    ...
    the pull request. The Checks API limits the number of annotations to a maximum
    of 50 per API request. To create more than 50 annotations, you have to make
    ...
    about how you can view annotations on GitHub, see
...
CheckRunCreateParams: TypeAlias = Union[Variant0, Variant1]
