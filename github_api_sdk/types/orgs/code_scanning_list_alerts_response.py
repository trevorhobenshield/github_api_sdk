...
from ..repos.code_scanning.code_scanning_alert_state import CodeScanningAlertState
from ..repos.code_scanning.code_scanning_analysis_tool import CodeScanningAnalysisTool
from ..repos.code_scanning.code_scanning_alert_instance import CodeScanningAlertInstance
from ..repos.code_scanning.code_scanning_alert_dismissed_reason import CodeScanningAlertDismissedReason

__all__ = ["CodeScanningListAlertsResponse", "CodeScanningListAlertsResponseItem"]


class CodeScanningListAlertsResponseItem(BaseModel):
    created_at: datetime
...
CodeScanningListAlertsResponse: TypeAlias = List[CodeScanningListAlertsResponseItem]
