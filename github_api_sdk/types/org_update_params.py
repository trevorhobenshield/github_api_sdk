...
class OrgUpdateParams(TypedDict, total=False):
    ...
    **Endpoint closing down notice.** Please use
    ...
    default_repository_permission: Literal["read", "write", "admin", "none"]
    ...
    **Endpoint closing down notice.** Please use
    ...
    members_allowed_repository_creation_type: Literal["all", "private", "none"]
    ...
    """
    Whether organization members can create internal repositories, which are visible
    ...
    """
    Whether organization members can create private repositories, which are visible
    ...
    """
    Whether organization members can create public repositories, which are visible
    ...
    **Endpoint closing down notice.** Please use
    ...
    """
    If `secret_scanning_push_protection_custom_link_enabled` is true, the URL that
    ...
    **Endpoint closing down notice.** Please use
    ...
    """
    Whether contributors to organization repositories are required to sign off on
