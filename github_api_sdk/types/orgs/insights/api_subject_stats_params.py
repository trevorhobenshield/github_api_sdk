...
__all__ = ["APISubjectStatsParams"]


class APISubjectStatsParams(TypedDict, total=False):
    ...
    """
    Providing a substring will filter results where the subject name contains the
