...
from ..repos.dependabot.dependabot_alert_package import DependabotAlertPackage
from ..repos.code_scanning.codeql.simple_repository import SimpleRepository
from ..repos.dependabot.dependabot_alert_security_advisory import DependabotAlertSecurityAdvisory
from ..repos.dependabot.dependabot_alert_security_vulnerability import DependabotAlertSecurityVulnerability

__all__ = ["AlertWithRepository", "Dependency"]
...
class AlertWithRepository(BaseModel):
    created_at: datetime
